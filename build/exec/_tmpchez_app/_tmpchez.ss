...
;; @generated by Idris 0.7.0-6d02c5210, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define Main-R (vector 0 "r"))
(define Main-L (vector 1 "l" Main-R (cons Main-R '())))
(define Main-LL (vector 1 "x" Main-L (cons Main-L '())))
(define Main-LLL (vector 1 "d" Main-LL (cons Main-LL '())))
...
(define Forj-u--show_Show_C-40NodeC-32C-36pC-41 (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (let ((e-0 (vector-ref arg-1 1))) e-0)) (else (let ((e-3 (vector-ref arg-1 1))) (let ((e-5 (vector-ref arg-1 3))) (string-append e-3 (string-append " - " (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 (cons (lambda (u--x) (Forj-u--show_Show_C-40NodeC-32C-36pC-41 u--x)) (lambda (u--d) (lambda (u--x) (Forj-u--show_Show_C-40NodeC-32C-36pC-41 u--x)))) e-5)))))))))
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append (Forj-u--show_Show_C-40NodeC-32C-36pC-41 Main-L) "\xa;") ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr (string-append (Forj-u--show_Show_C-40NodeC-32C-36pC-41 Main-LL) "\xa;") ext-0))) (PreludeC-45IO-prim__putStr (string-append (Forj-u--show_Show_C-40NodeC-32C-36pC-41 Main-LLL) "\xa;") ext-0)))))
