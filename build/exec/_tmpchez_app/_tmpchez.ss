...
(define Main-lookup (lambda (arg-4 arg-5) (cond ((equal? arg-4 0) (let ((e-12 (car arg-5))) e-12))(else (let ((e-8 (- arg-4 1))) (let ((e-18 (cdr arg-5))) (Main-lookup e-8 e-18)))))))
(define Main-interp (lambda (arg-3 arg-4) (case (vector-ref arg-4 0) ((0) (let ((e-4 (vector-ref arg-4 1))) (Main-lookup e-4 arg-3))) ((1) (let ((e-7 (vector-ref arg-4 1))) e-7)) ((2) (let ((e-12 (vector-ref arg-4 1))) (lambda (u--x) (Main-interp (cons u--x arg-3) e-12)))) ((3) (let ((e-17 (vector-ref arg-4 1))) (let ((e-18 (vector-ref arg-4 2))) ((Main-interp arg-3 e-17) (Main-interp arg-3 e-18))))) ((4) (let ((e-24 (vector-ref arg-4 1))) (let ((e-25 (vector-ref arg-4 2))) (let ((e-26 (vector-ref arg-4 3))) ((e-24 (Main-interp arg-3 e-25)) (Main-interp arg-3 e-26)))))) (else (let ((e-30 (vector-ref arg-4 1))) (let ((e-31 (vector-ref arg-4 2))) (let ((e-32 (vector-ref arg-4 3))) (let ((sc1 (Main-interp arg-3 e-30))) (cond ((equal? sc1 1) (Main-interp arg-3 (e-31))) (else (Main-interp arg-3 (e-32))))))))))))
(define Main-fact (lambda () (vector 2 (vector 5 (vector 4 (lambda (eta-0) (lambda (eta-1) (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer eta-0 eta-1))) (vector 0 0) (vector 1 0)) (lambda () (vector 1 1)) (lambda () (vector 4 (lambda (eta-0) (lambda (eta-1) (* eta-0 eta-1))) (vector 3 (Main-fact) (vector 4 (lambda (eta-0) (lambda (eta-1) (- eta-0 eta-1))) (vector 0 0) (vector 1 1))) (vector 0 0)))))))
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Enter a number: " ext-0))) (let ((act-2 (PreludeC-45IO-prim__getStr ext-0))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_Integer ((Main-interp '() (Main-fact)) (cast-string-int act-2))) "\xa;") ext-0)))))
