...
(define Main-showPrecTy (lambda (arg-0 arg-1) (case (vector-ref arg-1 0) ((0) "TyInt") ((1) "TyBool") ((2) "TyString") (else (let ((e-0 (vector-ref arg-1 1))) (let ((e-1 (vector-ref arg-1 2))) (DeriveC-45Show-conWithArgs arg-0 "TyFun" (cons (PreludeC-45Show-showArg (csegen-5) e-0) (cons (PreludeC-45Show-showArg (csegen-5) e-1) '())))))))))
...
(define csegen-15 (cons (cons "global" (cons (vector 0 ) 1)) (cons (cons "local" (cons (vector 2 ) "ok")) '())))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define Main-sub (vector 3 (vector 3 (vector 5 (lambda (eta-0) (lambda (eta-1) (bs- eta-0 eta-1 63))) (vector 0 0) (vector 0 1)))))
...
(define Main-showITy (lambda (arg-0 arg-1) (case (vector-ref arg-0 0) ((0) (PreludeC-45Show-u--show_Show_Int64 arg-1)) ((1) (PreludeC-45Show-u--show_Show_Bool arg-1)) ((2) (PreludeC-45Show-u--show_Show_String arg-1)) (else "TyFun"))))
...
(define PreludeC-45EqOrd-u--C-60C-61_Ord_Int64 (lambda (arg-0 arg-1) (let ((sc0 (or (and (<= arg-0 arg-1) 1) 0))) (cond ((equal? sc0 0) 0)(else 1)))))
(define Main-fact (lambda () (vector 3 (vector 6 (vector 5 (lambda (eta-0) (lambda (eta-1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Int64 eta-0 eta-1))) (vector 0 0) (vector 1 2)) (lambda () (vector 1 2)) (lambda () (vector 5 (lambda (eta-0) (lambda (eta-1) (bs* eta-0 eta-1 63))) (vector 4 (Main-fact) (vector 4 (vector 4 Main-sub (vector 1 1)) (vector 0 0))) (vector 0 0)))))))
...
(define Main-interp (lambda (arg-4 arg-5) (case (vector-ref arg-5 0) ((0) (let ((e-5 (vector-ref arg-5 1))) (Main-lookup e-5 arg-4))) ((1) (let ((e-9 (vector-ref arg-5 1))) e-9)) ((2) (let ((e-13 (vector-ref arg-5 1))) e-13)) ((3) (let ((e-19 (vector-ref arg-5 1))) (lambda (u--x) (Main-interp (cons u--x arg-4) e-19)))) ((4) (let ((e-25 (vector-ref arg-5 1))) (let ((e-26 (vector-ref arg-5 2))) ((Main-interp arg-4 e-25) (Main-interp arg-4 e-26))))) ((5) (let ((e-33 (vector-ref arg-5 1))) (let ((e-34 (vector-ref arg-5 2))) (let ((e-35 (vector-ref arg-5 3))) ((e-33 (Main-interp arg-4 e-34)) (Main-interp arg-4 e-35)))))) (else (let ((e-40 (vector-ref arg-5 1))) (let ((e-41 (vector-ref arg-5 2))) (let ((e-42 (vector-ref arg-5 3))) (let ((sc1 (Main-interp arg-4 e-40))) (cond ((equal? sc1 1) (Main-interp arg-4 (e-41))) (else (Main-interp arg-4 (e-42))))))))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_Int64 ((Main-interp '() (Main-fact)) 4)) "\xa;") ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40C-40EitherC-32C-36aC-41C-32C-36bC-41 csegen-11 (Main-namelookup "global" csegen-15)) "\xa;") ext-0))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40C-40EitherC-32C-36aC-41C-32C-36bC-41 csegen-11 (Main-namelookup "local" csegen-15)) "\xa;") ext-0)))))
