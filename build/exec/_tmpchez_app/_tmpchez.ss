...
(define DeriveC-45Show-conWithArgs (lambda (arg-0 arg-1 arg-2) (if (null? arg-2) arg-1 (PreludeC-45Show-showCon arg-0 arg-1 (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8510) (lambda (arg-8513) (string-append arg-8510 arg-8513))) "") (lambda (eta-0) eta-0) arg-2)))))
(define PreludeC-45Show-showArg (lambda (arg-1 arg-2) (string-append " " (let ((e-2 (cdr arg-1))) ((e-2 (vector 6 )) arg-2)))))
(define Main-showPrecTy (lambda (arg-0 arg-1) (case (vector-ref arg-1 0) ((0) "TyNat") ((1) "TyInt") ((2) "TyBool") ((3) "TyString") (else (let ((e-0 (vector-ref arg-1 1))) (let ((e-1 (vector-ref arg-1 2))) (DeriveC-45Show-conWithArgs arg-0 "TyFun" (cons (PreludeC-45Show-showArg (csegen-5) e-0) (cons (PreludeC-45Show-showArg (csegen-5) e-1) '())))))))))
(define csegen-5 (lambda () (LanguageC-45ReflectionC-45Derive-mkShowPrec (lambda (eta-0) (lambda (eta-1) (Main-showPrecTy eta-0 eta-1))))))
...
(define csegen-11 (cons (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_String u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_String u--d u--x)))) (csegen-5)))
(define csegen-15 (cons (cons "global" (cons (vector 1 ) 1)) (cons (cons "local" (cons (vector 3 ) "ok")) '())))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define Main-sub (vector 3 (vector 3 (vector 5 (lambda (eta-0) (lambda (eta-1) (PreludeC-45Types-prim__integerToNat (- eta-0 eta-1)))) (vector 0 0) (vector 0 1)))))
...
(define Main-showITy (lambda (arg-0 arg-1) (case (vector-ref arg-0 0) ((0) (PreludeC-45Show-u--show_Show_Nat arg-1)) ((1) (PreludeC-45Show-u--show_Show_Int64 arg-1)) ((2) (PreludeC-45Show-u--show_Show_Bool arg-1)) ((3) (PreludeC-45Show-u--show_Show_String arg-1)) (else (let ((e-0 (vector-ref arg-0 1))) (let ((e-1 (vector-ref arg-0 2))) (string-append "TyFun " (string-append (let ((sc1 (csegen-5))) (let ((e-3 (car sc1))) (e-3 e-0))) (let ((sc1 (csegen-5))) (let ((e-3 (car sc1))) (e-3 e-1)))))))))))
...
(define Main-namelookup (lambda (arg-0 arg-1) (if (null? arg-1) (vector 0 "Error not found") (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (let ((e-6 (car e-2))) (let ((e-7 (cdr e-2))) (let ((e-10 (car e-7))) (let ((e-11 (cdr e-7))) (let ((sc3 (PreludeC-45EqOrd-u--C-61C-61_Eq_String e-6 arg-0))) (cond ((equal? sc3 1) (vector 0 (string-append (let ((sc4 (csegen-5))) (let ((e-1 (car sc4))) (e-1 e-10))) (Main-showITy e-10 e-11)))) (else (Main-namelookup arg-0 e-3)))))))))))))
...
(define Main-fact (lambda () (vector 3 (vector 6 (vector 5 (lambda (eta-0) (lambda (eta-1) (PreludeC-45Types-u--C-60C-61_Ord_Nat eta-0 eta-1))) (vector 0 0) (vector 1 (vector 0 ) 2)) (lambda () (vector 1 (vector 0 ) 2)) (lambda () (vector 5 (lambda (eta-0) (lambda (eta-1) (* eta-0 eta-1))) (vector 4 (Main-fact) (vector 4 (vector 4 Main-sub (vector 1 (vector 0 ) 1)) (vector 0 0))) (vector 0 0)))))))
(define Main-lookup (lambda (arg-5 arg-6) (cond ((equal? arg-5 0) (let ((e-14 (car arg-6))) e-14))(else (let ((e-10 (- arg-5 1))) (let ((e-20 (cdr arg-6))) (Main-lookup e-10 e-20)))))))
(define Main-interp (lambda (arg-4 arg-5) (case (vector-ref arg-5 0) ((0) (let ((e-5 (vector-ref arg-5 1))) (Main-lookup e-5 arg-4))) ((1) (let ((e-10 (vector-ref arg-5 2))) e-10)) ((2) (let ((e-14 (vector-ref arg-5 1))) e-14)) ((3) (let ((e-20 (vector-ref arg-5 1))) (lambda (u--x) (Main-interp (cons u--x arg-4) e-20)))) ((4) (let ((e-26 (vector-ref arg-5 1))) (let ((e-27 (vector-ref arg-5 2))) ((Main-interp arg-4 e-26) (Main-interp arg-4 e-27))))) ((5) (let ((e-34 (vector-ref arg-5 1))) (let ((e-35 (vector-ref arg-5 2))) (let ((e-36 (vector-ref arg-5 3))) ((e-34 (Main-interp arg-4 e-35)) (Main-interp arg-4 e-36)))))) (else (let ((e-41 (vector-ref arg-5 1))) (let ((e-42 (vector-ref arg-5 2))) (let ((e-43 (vector-ref arg-5 3))) (let ((sc1 (Main-interp arg-4 e-41))) (cond ((equal? sc1 1) (Main-interp arg-4 (e-42))) (else (Main-interp arg-4 (e-43))))))))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_Nat ((Main-interp '() (Main-fact)) 4)) "\xa;") ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40C-40EitherC-32C-36aC-41C-32C-36bC-41 csegen-11 (Main-namelookup "global" csegen-15)) "\xa;") ext-0))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40C-40EitherC-32C-36aC-41C-32C-36bC-41 csegen-11 (Main-namelookup "local" csegen-15)) "\xa;") ext-0)))))
